...
KRX는 데이터셋별로 이용 신청과 승인이 필요합니다. **2026-08-29 기준 KRX Open API가 제공하는 31개 서비스를 전량 승인받아 수집 중**입니다(`recovery_ledger`의 `krx_access` 31건 모두 `complete`, 차단 0건). 운영 범위는 `KRX_MARKET_SCOPE=all`입니다.
