...
옵션은 하루 약 17,700계약(7.6MB)이 들어와 연 1.9GB가 쌓입니다. 용량이 부담되면 `KRX_MARKET_SCOPE=light`로 제외할 수 있습니다.
...
코넥스, ETN, 석유·금·배출권 시장, ELW, 선물·옵션, 채권 개별시장, ESG 등 **나머지 20여 개는 현재 소비하는 분석이 없습니다.** 승인받아도 DB만 커집니다. 필요해지면 그때 신청하세요.
